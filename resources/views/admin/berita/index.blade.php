                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <div class="flex items-center justify-end space-x-2">
                                ...
                                @if($berita->status === 'draft')
                                    <form action="{{ route('admin.berita.publish', $berita) }}" method="POST" class="inline">
                                        @csrf
                                        @method('PATCH')
                                        <button type="submit" class="text-green-600 hover:text-green-900 p-2 rounded-lg hover:bg-green-50 transition-colors duration-200" title="Publish">
                                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                @elseif($berita->status === 'published')
                                    <form action="{{ route('admin.berita.unpublish', $berita) }}" method="POST" class="inline">
                                        @csrf
                                        @method('PATCH')
                                        <button type="submit" class="text-orange-600 hover:text-orange-900 p-2 rounded-lg hover:bg-orange-50 transition-colors duration-200" title="Unpublish">
                                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <form action="{{ route('admin.berita.toggle-featured', $berita) }}" method="POST" class="inline">
                                    @csrf
                                    @method('PATCH')
                                    <button type="submit" class="p-2 rounded-lg transition-colors duration-200 {{ $berita->is_featured ? 'text-yellow-600 hover:text-yellow-900 hover:bg-yellow-50' : 'text-gray-400 hover:text-gray-600 hover:bg-gray-50' }}" title="Toggle Featured">
