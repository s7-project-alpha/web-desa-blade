                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <div class="flex space-x-2">
                                        <a href="{{ route('admin.kategori-galeri.show', $kategori) }}" class="text-blue-600 hover:text-blue-900">Lihat</a>
                                        <a href="{{ route('admin.kategori-galeri.edit', $kategori) }}" class="text-indigo-600 hover:text-indigo-900">Edit</a>
