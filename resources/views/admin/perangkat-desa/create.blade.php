...
<div class="flex justify-between items-center mb-6">
    <div>
        <h1 class="text-2xl font-bold text-gray-900">Tambah Perangkat Desa</h1>
        <p class="text-gray-600">Tambah data perangkat desa baru</p>
    </div>
...
<form action="{{ route('admin.perangkat-desa.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
    @csrf
        ...
        <div class="space-y-6">
            <div>
                ...
                <textarea name="pendidikan" id="pendidikan" rows="3"
                    class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                    placeholder="Contoh: S1 Ilmu Sosial - Universitas Negeri Jakarta">{{ old('pendidikan') }}</textarea>
            </div>
            ...
            <div id="visi-field" class="hidden">
                ...
                <textarea name="visi" id="visi" rows="3"
                    class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                    placeholder="Masukkan visi kepala desa">{{ old('visi') }}</textarea>
            </div>
            ...
            <div>
                ...
                <textarea name="tugas_tanggung_jawab" id="tugas_tanggung_jawab" rows="5"
                    class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                    placeholder="Masukkan tugas dan tanggung jawab, pisahkan dengan enter untuk tiap poin">{{ old('tugas_tanggung_jawab') }}</textarea>
...
// Trigger change event on page load to show/hide fields based on old value
