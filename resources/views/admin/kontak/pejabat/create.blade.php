{{-- resources/views/admin/kontak/pejabat/create.blade.php --}}
...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Tambah Kontak Pejabat</h1>
            <p class="text-gray-600 mt-1">Tambahkan informasi kontak pejabat desa baru</p>
        </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200">
        <form action="{{ route('admin.kontak.pejabat.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            @csrf
            ...
            <div class="px-6 pb-6 space-y-6">
                ...
                <div>
                    ...
                    <div class="flex items-center space-x-6">
                        <div class="shrink-0">
                            <img id="preview" class="h-16 w-16 object-cover rounded-full border-2 border-gray-300"
                                 src="https://ui-avatars.com/api/?name=Preview&background=e5e7eb&color=374151&size=64&font-size=0.5&rounded=true"
                                 alt="Preview">
                        </div>
                        <label class="block">
                    ...
                    <p class="text-xs text-gray-500 mt-2">Maksimal 2MB. Format: JPG, PNG, JPEG</p>
                    @error('foto')
                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <textarea id="deskripsi" name="deskripsi" rows="4"
                              ...
                              placeholder="Deskripsi singkat tentang pejabat">{{ old('deskripsi') }}</textarea>
                    @error('deskripsi')
                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
