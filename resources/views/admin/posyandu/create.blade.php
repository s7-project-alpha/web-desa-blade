...
<div class="mb-6">
    <div class="flex items-center space-x-4 justify-between">
       <div>
            <h1 class="text-3xl font-bold text-gray-900">Tambah Posyandu</h1>
            <p class="text-gray-600 mt-1">Tambah data posyandu baru</p>
        </div>
...
<div class="bg-white rounded-xl shadow-sm border border-gray-200">
    <div class="px-6 py-4 border-b border-gray-200">
        <h2 class="text-lg font-semibold text-gray-900">Form Data Posyandu</h2>
    </div>

    <form action="{{ route('admin.posyandu.store') }}" method="POST" class="p-6 space-y-6">
        @csrf
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
                ...
                <input type="text" name="nama" id="nama" required
                    ...
                    value="{{ old('nama') }}" placeholder="Contoh: Posyandu Mawar">
                @error('nama')
            ...
            <div>
                ...
                <input type="text" name="lokasi" id="lokasi" required
                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent"
                    value="{{ old('lokasi') }}" placeholder="Contoh: Balai Desa">
                @error('lokasi')
                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div>
                ...
                <input type="text" name="dusun" id="dusun" required
                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent"
                    value="{{ old('dusun') }}" placeholder="Contoh: Dusun Mawar">
                @error('dusun')
                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div>
                ...
                <input type="text" name="rt_rw" id="rt_rw" required
                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent"
                    value="{{ old('rt_rw') }}" placeholder="Contoh: RT 01-02">
                @error('rt_rw')
                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                @enderror
            </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div>
                ...
                <input type="text" name="jadwal" id="jadwal" required
                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent"
                    value="{{ old('jadwal') }}" placeholder="Contoh: Minggu ke-1 setiap bulan">
                @error('jadwal')
                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                @enderror
            </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
                ...
                <input type="text" name="penanggung_jawab" id="penanggung_jawab" required
                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent"
                    value="{{ old('penanggung_jawab') }}" placeholder="Contoh: Ibu Siti Aminah">
            ...
            <div>
                ...
                <input type="text" name="telepon_penanggung_jawab" id="telepon_penanggung_jawab" required
                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent"
                    value="{{ old('telepon_penanggung_jawab') }}" placeholder="0812-3456-7890">
