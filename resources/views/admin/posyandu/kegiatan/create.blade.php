{{-- resources/views/admin/posyandu/kegiatan/create.blade.php --}}
@extends('admin.layouts.app')

@section('content')
<div class="mb-6">
    <div class="flex items-center space-x-4">
        <a href="{{ route('admin.posyandu.kegiatan') }}" class="text-gray-600 hover:text-gray-900">
            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18"></path>
            </svg>
        </a>
        <div>
            <h1 class="text-3xl font-bold text-gray-900">Tambah Kegiatan Posyandu</h1>
            <p class="text-gray-600 mt-1">Tambah kegiatan posyandu baru</p>
        </div>
    </div>
</div>
...
<div class="bg-white rounded-xl shadow-sm border border-gray-200">
    <div class="px-6 py-4 border-b border-gray-200">
        <h2 class="text-lg font-semibold text-gray-900">Form Kegiatan Posyandu</h2>
    </div>

    <form action="{{ route('admin.posyandu.kegiatan.store') }}" method="POST" class="p-6 space-y-6">
        @csrf
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
                ...
                <input type="text" name="nama_kegiatan" id="nama_kegiatan" required
                    ...
                    value="{{ old('nama_kegiatan') }}" placeholder="Contoh: Penimbangan Balita dan Imunisasi">
                @error('nama_kegiatan')
            ...
            <div>
                ...
                <select name="posyandu_id" id="posyandu_id" required
                    ...
                    <option value="{{ $item->id }}" {{ old('posyandu_id') == $item->id ? 'selected' : '' }}>
        ...
        <div>
            ...
            <div id="agenda-container">
                @if(old('agenda'))
                    @foreach(old('agenda') as $index => $agenda)
