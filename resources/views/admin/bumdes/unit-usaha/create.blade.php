...
<div class="flex justify-between items-center mb-6">
    <div>
        <h1 class="text-2xl font-bold text-gray-900">Tambah Unit Usaha</h1>
        <p class="text-gray-600">Tambah unit usaha baru untuk {{ $bumdes->nama }}</p>
    </div>
...
<form action="{{ route('admin.bumdes.unit-usaha.store') }}" method="POST" class="space-y-6">
    @csrf
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input type="number" name="jumlah_anggota" id="jumlah_anggota" value="{{ old('jumlah_anggota', 0) }}" required min="0"
                    class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                    placeholder="156">
            </div>
            ...
            <div class="md:col-span-2">
                ...
                <textarea name="deskripsi" id="deskripsi" rows="4"
                    class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                    placeholder="Layanan kredit mikro untuk modal usaha warga dengan bunga rendah">{{ old('deskripsi') }}</textarea>
            </div>
        </div>
    </div>
