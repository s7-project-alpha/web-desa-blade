...
<div class="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-6">
    ...
    <div class="flex flex-col sm:flex-row gap-2 w-full sm:w-auto mt-4 sm:mt-0">
        <a href="{{ route('admin.bumdes.unit-usaha.create') }}"class="w-full sm:w-auto bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg font-medium flex items-center justify-center">
