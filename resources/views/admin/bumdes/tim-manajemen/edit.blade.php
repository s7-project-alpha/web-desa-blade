...
<div class="flex justify-between items-center mb-6">
    <div>
        <h1 class="text-2xl font-bold text-gray-900">Edit Tim Manajemen</h1>
        <p class="text-gray-600">Edit {{ $timManajemen->nama }}</p>
    </div>
...
<form action="{{ route('admin.bumdes.tim-manajemen.update', $timManajemen) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
    @csrf
    @method('PUT')
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
                ...
                <input type="text" name="nama" id="nama" value="{{ old('nama', $timManajemen->nama) }}" required
            ...
            <div>
                ...
                <input type="text" name="jabatan" id="jabatan" value="{{ old('jabatan', $timManajemen->jabatan) }}" required
                    class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
            ...
            <div>
                ...
                <input type="number" name="urutan" id="urutan" value="{{ old('urutan', $timManajemen->urutan) }}" min="0"
                    class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                    placeholder="0">
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
                ...
                <input type="text" name="telepon" id="telepon" value="{{ old('telepon', $timManajemen->telepon) }}"
                    class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
            ...
            <div>
                ...
                <input type="email" name="email" id="email" value="{{ old('email', $timManajemen->email) }}"
                    class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
        ...
        <div class="space-y-6">
            <div>
                ...
                <textarea name="pengalaman" id="pengalaman" rows="3"
                    class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                    placeholder="Contoh: 5 tahun di bidang koperasi">{{ old('pengalaman', $timManajemen->pengalaman) }}</textarea>
            </div>

            <div class="space-y-4">
                @if($timManajemen->foto)
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Foto Saat Ini</label>
                        <div class="w-32 h-32 rounded-lg overflow-hidden bg-gray-200">
                            <img src="{{ $timManajemen->foto_url }}" alt="{{ $timManajemen->nama }}" class="w-full h-full object-cover">
                        </div>
                    </div>
                @endif
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        ...
        <div class="flex items-center">
            <input type="checkbox" name="is_active" id="is_active" value="1" {{ old('is_active', $timManajemen->is_active) ? 'checked' : '' }}
