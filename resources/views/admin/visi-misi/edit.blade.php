...
<div class="mb-6">
    <div class="flex items-center justify-between">
      <div>
         ...
         <a href="{{ route('admin.visi-misi.index') }}" class="bg-gray-600 hover:bg-gray-700 text-white px-4 py-2 rounded-lg font-medium flex items-center">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="periode_awal" id="periode_awal"
                               ...
                               placeholder="2024" value="{{ old('periode_awal', $visiMisi->periode_awal) }}" maxlength="4" required>
                    </div>
                    <div>
                        ...
                        <input type="text" name="periode_akhir" id="periode_akhir"
                               class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                               placeholder="2030" value="{{ old('periode_akhir', $visiMisi->periode_akhir) }}" maxlength="4" required>
                    </div>
                </div>
            </div>
            ...
            <div class="lg:col-span-2">
                ...
                <textarea name="visi" id="visi" rows="4"
                          class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                          placeholder="Masukkan visi desa..." required>{{ old('visi', $visiMisi->visi) }}</textarea>
            ...
            <div class="lg:col-span-2">
                ...
                <textarea name="misi" id="misi" rows="8"
                          class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                          placeholder="1. Misi pertama&#10;2. Misi kedua&#10;3. Misi ketiga" required>{{ old('misi', $visiMisi->misi) }}</textarea>
            ...
            <div class="lg:col-span-2">
                ...
                <textarea name="nilai_dasar" id="nilai_dasar" rows="6"
                          class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                          placeholder="1. Nilai dasar pertama&#10;2. Nilai dasar kedua&#10;3. Nilai dasar ketiga">{{ old('nilai_dasar', $visiMisi->nilai_dasar) }}</textarea>
            ...
            <div>
                ...
                <textarea name="tujuan" id="tujuan" rows="6"
                          class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                          placeholder="1. Tujuan pertama&#10;2. Tujuan kedua">{{ old('tujuan', $visiMisi->tujuan) }}</textarea>
            ...
            <div>
                ...
                <textarea name="sasaran" id="sasaran" rows="6"
                          class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                          placeholder="1. Sasaran pertama&#10;2. Sasaran kedua">{{ old('sasaran', $visiMisi->sasaran) }}</textarea>
