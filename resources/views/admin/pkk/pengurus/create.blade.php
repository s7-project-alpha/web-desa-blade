...
<div class="flex items-center justify-between mb-6">
    <div>
        <h1 class="text-2xl font-bold text-gray-900">Tambah Pengurus PKK</h1>
        <p class="text-gray-600">Tambahkan pengurus baru untuk PKK Desa Tanjung Selamat</p>
    </div>
...
<form action="{{ route('admin.pkk.pengurus.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
    @csrf
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        ...
        <div class="mt-6">
            ...
            <textarea name="deskripsi"
                      ...
                      rows="3"
                      class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                      placeholder="Deskripsi singkat tentang pengurus...">{{ old('deskripsi') }}</textarea>
        </div>
        ...
        <div class="mt-6">
            ...
            <textarea name="tugas"
                      ...
                      rows="4"
                      class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                      placeholder="Tugas dan tanggung jawab pengurus...">{{ old('tugas') }}</textarea>
        </div>
