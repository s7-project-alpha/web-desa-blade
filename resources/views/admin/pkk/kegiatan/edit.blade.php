...
<div class="flex items-center justify-between mb-6">
    <div>
        <h1 class="text-2xl font-bold text-gray-900">Edit Kegiatan PKK</h1>
        <p class="text-gray-600">Perbarui kegiatan {{ $kegiatan->nama_kegiatan }}</p>
    </div>
...
<form action="{{ route('admin.pkk.kegiatan.update', $kegiatan) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
    @csrf
    @method('PUT')
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <select name="status"
                    ...
                    <option value="sedang_berlangsung" {{ old('status', $kegiatan->status) == 'sedang_berlangsung' ? 'selected' : '' }}>Sedang Berlangsung</option>
        ...
        <div class="mt-6">
            ...
            @if($kegiatan->foto)
                <div class="mb-4">
                    <img src="{{ $kegiatan->foto_url }}" alt="{{ $kegiatan->nama_kegiatan }}" class="w-48 h-32 object-cover rounded-lg">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input type="time"
                       name="waktu"
                       id="waktu"
                       value="{{ old('waktu', $kegiatan->waktu ? $kegiatan->waktu->format('H:i') : '') }}"
                       class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
            </div>
        </div>
