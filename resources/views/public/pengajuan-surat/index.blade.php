...
<div class="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-8">
    <div class="flex items-start">
        ...
        <div class="ml-3 flex-1">
            ...
            <!-- Reminder Dokumen dengan Icon Warning -->
            <div class="mt-4 pt-4 border-t border-blue-300">
                <div class="flex items-start">
                    ...
                    <div class="ml-2">
                        <p class="text-sm font-semibold text-blue-800">Dokumen yang Harus Dibawa Saat Mengambil Surat:</p>
                        <div class="mt-1 text-sm text-blue-700 space-y-1">
                            <p>• <strong>KTP (Kartu Tanda Penduduk)</strong> - Asli dan masih berlaku</p>
                            <p>• <strong>KK (Kartu Keluarga)</strong> - Asli atau fotokopi yang telah dilegalisir</p>
                        </div>
                    </div>
                </div>
            </div>
