    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div class="bg-white rounded-lg shadow-lg p-6 text-center">
                ...
                <h3 class="text-3xl font-bold text-gray-900 mb-2">{{ $demografi ? number_format($demografi->total_penduduk) : '2,580' }}</h3>
            ...
            <div class="bg-white rounded-lg shadow-lg p-6 text-center">
                ...
                <h3 class="text-3xl font-bold text-gray-900 mb-2">{{ $demografi ? number_format($demografi->total_kepala_keluarga) : '745' }}</h3>
            ...
            <div class="bg-white rounded-lg shadow-lg p-6 text-center">
                ...
                <h3 class="text-3xl font-bold text-gray-900 mb-2">{{ $demografi ? $demografi->luas_wilayah : '12.5' }}</h3>
            ...
            <div class="bg-white rounded-lg shadow-lg p-6 text-center">
                ...
                <h3 class="text-3xl font-bold text-gray-900 mb-2">{{ $demografi ? $demografi->jumlah_dusun : '8' }}</h3>
...
<section class="py-16 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div class="bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg p-6 hover:shadow-lg transition duration-200">
            ...
            <div class="bg-gradient-to-br from-green-50 to-green-100 rounded-lg p-6 hover:shadow-lg transition duration-200">
            ...
            <div class="bg-gradient-to-br from-purple-50 to-purple-100 rounded-lg p-6 hover:shadow-lg transition duration-200">
...
<section class="py-16 bg-gray-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <!-- Sample News 1 -->
            <article class="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition duration-200">
